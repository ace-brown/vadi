...
export default function AnimalBasedProductsPage() {
  ...
  async function fetchAnimalBasedProds() {
    try {
      const responseData = await sendRequest(
        `${import.meta.env.VITE_API_URL}/api/agriculture/animal-based-products`,
        "GET"
      );
  ...
  return (
    <CustomCompareLayout
      ...
      returnTxt="بازگشت به صحفه ی انتخاب نوع خدمات کشاورزی"
      returnSlug="/agriculture/agriculture-details-select"
    >
